                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex justify-between items-center mb-6">
                            <h2 class="text-2xl font-bold text-gray-900">Add New Chord</h2>
                    ...
                    <form action="{{ route('admin.chord-presets.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" name="starting_fret" value="{{ old('starting_fret', 0) }}" min="0" required
                                       class="w-full border-2 border-gray-300 rounded px-3 py-2 focus:border-black focus:ring-0">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Number of Frets</label>
                                <input type="number" name="num_frets" value="{{ old('num_frets', 5) }}" min="3" max="12" required
                                       class="w-full border-2 border-gray-300 rounded px-3 py-2 focus:border-black focus:ring-0">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Number of Strings</label>
                                <input type="number" name="num_strings" value="{{ old('num_strings', 6) }}" min="4" max="8" required
                                       class="w-full border-2 border-gray-300 rounded px-3 py-2 focus:border-black focus:ring-0">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="fingers" rows="4" required
                                      class="w-full border-2 border-gray-300 rounded px-3 py-2 focus:border-black focus:ring-0 font-mono text-sm">{{ old('fingers', '[{"string":0,"fret":1}]') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="open_strings" rows="2"
                                      class="w-full border-2 border-gray-300 rounded px-3 py-2 focus:border-black focus:ring-0 font-mono text-sm">{{ old('open_strings', '[]') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="muted_strings" rows="2"
                                      class="w-full border-2 border-gray-300 rounded px-3 py-2 focus:border-black focus:ring-0 font-mono text-sm">{{ old('muted_strings', '[]') }}</textarea>
...
<script>
    ...
    // Update preview when JSON fields change
