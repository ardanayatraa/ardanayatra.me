        ...
        <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white border-2 border-gray-200 rounded-lg p-4 sm:p-6 hover:border-gray-300 transition">
                ...
                <textarea name="lyrics" rows="8" 
                          ...
                          placeholder="Enter lyrics here...">{{ old('lyrics') }}</textarea>
            ...
            <div class="bg-white border-2 border-gray-200 rounded-lg p-4 sm:p-6 hover:border-gray-300 transition">
                ...
                <select name="music_role" class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-black focus:ring-0 transition">
                    ...
                    <option value="arranger" {{ old('music_role') == 'arranger' ? 'selected' : '' }}>Arranger (Penata Musik)</option>
                    <option value="songwriter" {{ old('music_role') == 'songwriter' ? 'selected' : '' }}>Song Writer (Penulis Lagu)</option>
                    <option value="both" {{ old('music_role') == 'both' ? 'selected' : '' }}>Arranger & Song Writer</option>
                </select>
